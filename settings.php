<?php include("includes/header.php");
  ...
  if(isset($_POST['verify_purchase_submit']))
  {
     ...
     if($_POST['envato_buyer_name']!='' AND $envato_buyer->buyer==$_POST['envato_buyer_name'])
      {
            $data = array(
  ...
  if(isset($_POST['api_submit']))
  {
        ...
        $data = array(
                ...
                'api_lan_order_by'  =>  $_POST['api_lan_order_by'],
                'api_gen_order_by'  =>  $_POST['api_gen_order_by']
                  );
      ...
      <div class="page_title_block">
          ...
          <div class="card-body mrg_bottom">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#verify_purchase" aria-controls="verify_purchase" role="tab" data-toggle="tab">Package Name</a></li>
              ...
              <form action="" name="verify_purchase" method="post" class="form form-horizontal" enctype="multipart/form-data" id="api_form">
                ...
                <div class="section-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <input type="text" name="envato_buyer_name" id="envato_buyer_name" value="<?php echo $settings_row['envato_buyer_name'];?>" class="form-control" placeholder="web">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-3 control-label">

                      <p class="control-label-help">(<a href="https://0.0.0.0" target="_blank">Where Is My Purchase Code?</a>)</p>
                    </label>
                    <div class="col-md-6">
